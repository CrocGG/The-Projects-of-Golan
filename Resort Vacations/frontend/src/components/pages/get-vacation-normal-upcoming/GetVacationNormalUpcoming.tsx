...
import "./GetVacationNormalUpcoming.css"
...
export default function GetVacationNormalUpcoming() {

    useTitle('Vacations - Normal - Upcoming');
    ...
    useEffect(() => {
        (async () => {
            try {
                const vacations = await vacationService.getVacationsUpcoming();
    ...
    return (
        <div className="vacation-list">
            <h1 className='vacations-title'>Vacation List - Upcoming</h1>
