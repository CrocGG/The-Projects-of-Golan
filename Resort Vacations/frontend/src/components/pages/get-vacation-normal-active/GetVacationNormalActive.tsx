...
import "./GetVacationNormalActive.css"
...
export default function GetVacationNormalActive() {

    useTitle('Vacations - Normal - Active');
    ...
    useEffect(() => {
        (async () => {
            try {
                const vacations = await vacationService.getVacationsActive();
    ...
    return (
        <div className="vacation-list">
            <h1 className='vacations-title'>Vacation List - Active</h1>
