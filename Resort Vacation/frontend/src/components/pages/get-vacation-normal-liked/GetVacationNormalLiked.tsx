...
import "./GetVacationNormalLiked.css"
...
export default function GetVacationNormalLiked() {

    useTitle('Vacations - Normal - Liked');
    ...
    useEffect(() => {
        (async () => {
            try {
                const vacations = await vacationService.getVacationsLiked();
    ...
    return (
        <div className="vacation-list">
            <h1 className='vacations-title'>Vacation List - Liked</h1>
            <div className="filter-checkbox-container">
                <NavLink to={`/vacation/vacation-normal/vacation-every`}>
                    <button>Every</button>
                </NavLink>
